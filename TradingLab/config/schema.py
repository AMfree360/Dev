...
class CalendarFiltersConfig(BaseModel):
    ...
    master_filters_enabled: bool = True
    ...
    trading_sessions: Dict[str, TradingSessionConfig] = Field(
        default_factory=lambda: {
            "Asia": TradingSessionConfig(enabled=True, start="23:00", end="08:00"),
            "London": TradingSessionConfig(enabled=True, start="07:00", end="16:00"),
            "NewYork": TradingSessionConfig(enabled=True, start="13:00", end="21:00"),
        },
