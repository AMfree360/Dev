...
class ValidationSuitabilityAssessor:
    ...
    def assess_strategy(self, backtest_result: BacktestResult) -> StrategyProfile:
        ...
        # Get number of bars (from equity curve or estimate)
    ...
    def get_test_suitability(
        ...
        # Almost always suitable (tests true edge regardless of strategy type)
