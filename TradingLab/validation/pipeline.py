...
class ValidationPipeline:
    ...
    def run_phase2_oos(
        ...
        # The walk-forward analyzer needs access to data BEFORE oos_start for indicator warm-up
    ...
    def _print_phase1_results(self, result: TrainingValidationResult):
        ...
        if 'permutation' in result.monte_carlo_results:
            ...
            if 'randomized_entry' in mc:
                ...
                print(f"     Status: ✅ COMPLETED (Universal Test)")
            ...
            if 'combined' in mc:
                ...
                print(f"     ⚠️  Use combined score ONLY for automated pass/fail threshold.")
