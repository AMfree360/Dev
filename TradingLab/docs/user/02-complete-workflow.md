...
2. Review Monte Carlo permutation results
...
2. **Monte Carlo Permutation**: Tests if results are better than random
3. **Parameter Sensitivity**: Tests if strategy is robust to parameter changes

**Understanding Results**:

**Monte Carlo Permutation Test**:
- **P-Value**: Probability that results are due to luck
  - ✅ Good: p-value < 0.05 (less than 5% chance it's luck)
  - ❌ Bad: p-value > 0.05 (likely due to luck)
- **Percentile Rank**: How your strategy ranks vs. random
  - ✅ Good: percentile >= 50% (better than random)
  - ❌ Bad: percentile < 50% (worse than random)
...
Monte Carlo Permutation:
  final_pnl: p-value=0.0120, percentile=98.8% ✓ PASS
  sharpe: p-value=0.0080, percentile=99.2% ✓ PASS
  pf: p-value=0.0150, percentile=98.5% ✓ PASS
...
Monte Carlo Permutation:
  final_pnl: p-value=0.3210, percentile=67.9% ✗ FAIL
  sharpe: p-value=0.1730, percentile=82.7% ✗ FAIL
  pf: p-value=0.6190, percentile=38.1% ✗ FAIL
