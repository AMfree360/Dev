...
#### 2. Monte Carlo Permutation Section

Shows for each metric (final_pnl, sharpe, pf):
- **Observed**: Your actual result
- **P-Value**: Probability it's random (lower is better)
- **Percentile Rank**: Where you rank vs random (higher is better)

**What to look for**:
- ✅ P-value < 0.05 (95% confidence it's not random)
- ✅ High percentile rank (> 80%)
