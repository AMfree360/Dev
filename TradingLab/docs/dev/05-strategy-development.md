...
1. **Follow the Complete Workflow**: [WORKFLOW.md](WORKFLOW.md) - This provides a step-by-step process for testing and validating your strategy
...
If you're stuck:
1. Look at the `titanea` example strategy
