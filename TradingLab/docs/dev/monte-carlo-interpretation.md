...
- Randomized Entry: 50% (most important - tests entry contribution)
- Bootstrap: 30% (tests market robustness)
- Permutation: 20% (tests order independence)
...
1. **Randomized Entry**: Most important (tests entry contribution)
2. **Bootstrap**: Important (tests market robustness)
3. **Permutation**: Less important (tests order independence, often not suitable)
