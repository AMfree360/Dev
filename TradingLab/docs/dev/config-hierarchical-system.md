...
2. **`strategies/titanmaster/configs/EURUSD.yml`**: Example EURUSD config
3. **`strategies/titanmaster/configs/MES.yml`**: Example MES config
4. **`strategies/titanmaster/CONFIG_GUIDE.md`**: User guide
